...
\subsection{Moodle}
\IEEEPARstart{M}{oodle} (Modular Object Oriented Dynamic Learning Environment) é um Ambiente Virtual de Ensino e Aprendizagem (AVEA), 
...
%\bibliography{IEEEabrv,bib/referencias}
