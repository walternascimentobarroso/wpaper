...
pdftitle={Auxílio de deficientes visuais em plataforma de ensino online usando tecnicas de inteligencia artificial},%<!CHANGE!
pdfsubject={Typesetting},%<!CHANGE!
pdfauthor={Walter N. Barroso},%<!CHANGE!
pdfkeywords={Educação a distância, Deficientes visuais, Ensino online, Inteligência artificial, Raciocínio baseado em casos}}%<^!CHANGE!
...
\author{
	Walter~Nascimento~Barroso,\textit{~Mestrando do PPGI - UFAM}% <-this % stops a space
	
	\IEEEcompsocitemizethanks{
		\IEEEcompsocthanksitem E-mail: walter.nascimento@icomp.ufam.edu.br
	}
}

\markboth{PROGRAMA DE PÓS-GRADUAÇÃO EM INFORMÁTICA - PPGI (UFAM), Janeiro~de~2017}%
...
\begin{abstract}
O ensino a distância tem um papel muito importante nos dias de hoje, de tal forma que instituições que oferecem cursos migraram 
para a web. e a cada dia surgem novos trabalhos melhorando o ensino, mas em alguns casos é deixado de lado as pessoas com 
necessidades, em especial o deficiente visual. Logo este trabalho mostra algumas técnicas e ferramentas utilizadas para a inclusão 
de pessoas com deficiência visual.
\end{abstract}

% Note that keywords are not normally used for peerreview papers.
\begin{IEEEkeywords}
Educação a distância, Deficientes visuais, Ensino online, Inteligência artificial, Raciocínio baseado em casos.
\end{IEEEkeywords}}
...
\IEEEPARstart{O} uso de tecnologias na educação está cada vez mais maior no mundo todo, principalmente por influência da da internet, 
...
\IEEEPARstart{A} vasta facilidade de acesso a internet e da necessidade de ambientes educacionais que suportem 
...
\IEEEPARstart{D}{iversos} trabalhos vêm sendo realizados, em diferentes linhas de pesquisa, com o objetivo de auxiliar pessoas cegas a 
...
\IEEEPARstart{A} introdução de técnicas de inteligência artificial nestes ambientes tem diversas finalidades, 
...
\section{Conclusão}
\IEEEPARstart{T}{odos} os trabalhos abordam formas e ferramentas diferentes para a inclusão do deficiente visual no mundo da educação. 
